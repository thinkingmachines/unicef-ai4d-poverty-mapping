...
![Rollout Process showing the four main model rollout steps: generating tiles over country, filtering to populated tiles using High Resolution Settlement Layer (HRSL), feature engineering, and model estimateion](assets/rollout_process.png)
...
![Snapshots of estimated relative wealth indexes for various areas in SEA](assets/rollout_results.gif)
...
- Indoensia [OpenStreetMap](https://download.geofabrik.de/asia/indonesia.html) data is processed in batches based on major islands: Java, Kalimantan, Maluku, Sulawesi, Sumatra, Papua, Nusa-Tenggara
