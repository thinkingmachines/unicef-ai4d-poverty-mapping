...
## Cross-country regressor with wealth index normalized per-country {#sec-exp-2}

[📒 Notebook link](notebooks/2023-01-24-dhs-cross-country-experiments/2023-01-24_crosscountry_initial.ipynb)

*Insert commentary*

## Cross-country regressor with wealth index recalculated using the pooled data for the four countries {#sec-exp-3}

[📒 Notebook link](notebooks/2023-02-01-index-recalculation-experiments/2023-02-06_index_recalculation.ipynb)

*Insert commentary*

## Cross-country regressor with both wealth index and input features normalized per-country {#sec-exp-4}
